    ...
    <div class="contents">
        ...
        <ul class="memberInfo_wrap">
			...
			<div class="ad-partner">
                <a href="http://www.cgv.co.krevent/detailViewUnited.jsp?seq=31426&menu=006"  >
            ...
            <li><a href="/user/login/?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fculture-event%2fpopcorn-store%2fproduct-detail.jsp%3fGG_NO%3d100253"><img src="https://img.cgv.co.kr/R2014/images/common/ico/loginPassword.png" alt="로그인" /><span>로그인</span></a></li>
            ...
            <li><a href="/support/default.jsp"><img src="https://img.cgv.co.kr/R2014/images/common/ico/loginCustomer.png" alt="고객센터" /><span>고객센터</span></a></li>
        </ul>
    </div>
</div>
        ...
        <ul class="nav_menu">
            <li>
                ...
                <dl class="nav_overMenu">
                    ...
                    <dd><h3><a href="event/detailViewUnited.jsp?seq=30717">ICECON</a></h3></dd>
                </dl>
            </li>
            <li>
            ...
            <li>
                ...
                <dl class="nav_overMenu">
                    ...
                    <dd><h3><a href="/ticket/eng/newdefault.jsp">English Ticketing</a></h3></dd>
                    <dd><h3><a href="/reserve/show-times/eng/">English Schedule</a></h3></dd>
                </dl>
            </li>
            <li>
                <h2><a href="popcorn-store/">스토어</a></h2>
                <dl class="nav_overMenu">
                    <dt><h2><a href="popcorn-store/" tabindex="-1">스토어</a></h2></dt>
                    
                            <dd><h3><a href="popcorn-store/store-category.jsp?CategoryIdx=2">영화관람권</a></h3></dd>
                        
                            <dd><h3><a href="popcorn-store/store-category.jsp?CategoryIdx=3">기프트카드</a></h3></dd>
                        
                            <dd><h3><a href="popcorn-store/store-category.jsp?CategoryIdx=4">콤보</a></h3></dd>
                        
                            <dd><h3><a href="popcorn-store/store-category.jsp?CategoryIdx=5">팝콘</a></h3></dd>
                        
                            <dd><h3><a href="popcorn-store/store-category.jsp?CategoryIdx=6">음료</a></h3></dd>
                        
                            <dd><h3><a href="popcorn-store/store-category.jsp?CategoryIdx=7">스낵</a></h3></dd>
                        
                            <dd><h3><a href="popcorn-store/store-category.jsp?CategoryIdx=10">플레이존</a></h3></dd>
                        
                    <dd><h3><a href="https://brand.naver.com/cgv" class="arrowR" target="_blank">씨네샵</a></h3></dd>
                </dl>
            </li>
            <li>
                <h2 onclick="gaEventLog('PC_GNB','주메뉴_이벤트','')"><a href="event/defaultNew.jsp">이벤트</a></h2>
                <dl class="nav_overMenu">
                    <dt><h2><a href="event/defaultNew.jsp?mCode=001" tabindex="-1">이벤트</a></h2></dt>
                    <dd><h3><a href="event/defaultNew.jsp?mCode=001">SPECIAL</a></h3></dd>
                    <dd><h3><a href="event/defaultNew.jsp?mCode=004">영화/예매</a></h3></dd>
                    <dd><h3><a href="event/defaultNew.jsp?mCode=008">멤버십/CLUB</a></h3></dd>
                    <dd><h3><a href="event/defaultNew.jsp?mCode=005">CGV 극장별</a></h3></dd>
                    <dd><h3><a href="event/defaultNew.jsp?mCode=006">제휴할인</a></h3></dd>
                    <dd><h3><a href="/user/mycgv/event/result_list.jsp">당첨자 발표</a></h3></dd>
                    <dd><h3><a href="event/end-list.jsp">종료된 이벤트</a></h3></dd>
                </dl>
            </li>
            <li>
                <h2 onclick="gaEventLog('PC_GNB','주메뉴_해택','')"><a href="/discount/discountlist.jsp">혜택</a></h2>
                <dl class="nav_overMenu">
                    <dt><h2><a href="/discount/discountlist.jsp" tabindex="-1">혜택</a></h2></dt>
                    <dd><h3><a href="/discount/discountlist.jsp">CGV 할인정보</a></h3></dd>
                    <dd><h3><a href="https://www.cgv.co.kr/user/memberShip/ClubService.jsp">CLUB 서비스</a></h3></dd>
...
<script language="javascript" type="text/javascript">
    ...
    function fnCategoryData(cno) {
        location.href="popcorn-store/store-category.jsp?CategoryIdx=" + cno;
    }
...
<ul class="policy_list">
    ...
    <li><a href="http://corp.cgv.co.kr/company/ir/financial/financial_list.jsp" target="_blank">IR</a></li>
    <li><a href="http://corp.cgv.co.kr/company/recruit/step/default.jsp" target="_blank">채용정보</a></li>
    <li><a href="http://corp.cgv.co.kr/company/advertize/ad_Default.jsp" target="_blank">광고/제휴/출점문의</a></li>
    <li><a href="http://www.cgv.co.kr/rules/service.jsp">이용약관</a></li>
    <li><a href="http://www.cgv.co.kr/rules/organized.jsp">편성기준</a></li>
    <li><a href="http://www.cgv.co.kr/rules/privacy.jsp"><strong>개인정보처리방침</strong></a></li>
    <li><a href="http://www.cgv.co.kr/rules/disclaimer.jsp">법적고지</a></li>
    <li><a href="http://www.cgv.co.kr/rules/emreject.jsp">이메일주소무단수집거부</a></li>
    <li><a href="http://corp.cgv.co.kr/company/ethicalManagement/ceoMessage.jsp" target="_blank">윤리경영</a></li>
    <li><a href="/company/cyberAudit.jsp" class="empha-red">사이버감사실</a></li>
</ul>
	...
	<div id="ctl00_sect_person_right" class="sect-aside-banner" style="padding:0; margin:0; position:fixed; z-index:1;display:none">
		<div class="aside-content-top">
			<div class="aside-content-btm">
				...
				<a href="/discount/discountlist.jsp"><img src="https://img.cgv.co.kr/R2014/images/common/btn/btn_person_discount.gif" alt="CGV DISCOUNT INFO" /></a>
			</div>
		</div>
		<div class="btn-top">
