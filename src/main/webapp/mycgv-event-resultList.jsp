...
<html>
<head>
    <title>mycgv-event-resultList</title>
    ...
    <div id="contents" class="">
        ...
        <div class="cols-content" id="menu">
            ...
            <div class="col-detail" id="mycgv_contents">
                ...
                <!-- 탭 활성화시 button 클래스에 on을 넣어주세요 작업다 완료시 이 주석은 제거해주세요-->
                <div class="sort_event">
                    <div>
                        <ul class="cf">
                            <li><a href="./mycgv-event.jsp" class="on">
                                <button>
                                    응모내역</button></a></li>
                            <li><a href="./mycgv-event-resultList.jsp">
                                <button class="on">
                                    당첨자 발표</button></a></li>
                        </ul>
                    </div>
                        ...
                        <div class="col-detail">
                            <div class="tbl-data">
                                <table summary="당첨자 발표 리스트">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detail_view.aspx?idx=32617&LUCKEYIDX=6752&page=1">
                                                IMAX WORLD TRAVEL 이벤트 경품 당첨자 안내</a>
                                        </td>
                                        <td>
                                            2021.07.06
                                            ~
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detail_view.aspx?idx=33806&LUCKEYIDX=6758&page=1">
                                                [제페토CGV 오픈 사전 이벤트] 당첨자 발표 안내</a>
                                        </td>
                                        <td>
                                            2022.01.06
                                            ~
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detail_view.aspx?idx=33901&LUCKEYIDX=6761&page=1">
                                                [해적: 도깨비 깃발] 기대평 댓글 이벤트 당첨자 안내</a>
                                        </td>
                                        <td>
                                            2022.01.21
                                            ~
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detail_view.aspx?idx=33843&LUCKEYIDX=6759&page=1">
                                                &lt;만년이 지나도 변하지 않는게 있어&gt; CGV회원 시사회 이벤트 당첨자 안내</a>
                                        </td>
                                        <td>
                                            2022.01.12
                                            ~
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detail_view.aspx?idx=33892&LUCKEYIDX=6757&page=1">
                                                &lt;해적: 도깨비 깃발&gt; CGV회원 시사회 이벤트 당첨자 안내</a>
                                        </td>
                                        <td>
                                            2022.01.19
                                            ~
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detail_view.aspx?idx=33823&LUCKEYIDX=6756&page=1">
                                                &lt;특송&gt; 기대평 댓글 이벤트 당첨자 발표 안내</a>
                                        </td>
                                        <td>
                                            2022.01.07
                                            ~
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detail_view.aspx?idx=33842&LUCKEYIDX=6755&page=1">
                                                &lt;원 세컨드&gt; CGV회원 시사회 이벤트 당첨자 안내</a>
                                        </td>
                                        <td>
                                            2022.01.12
                                            ~
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detail_view.aspx?idx=33846&LUCKEYIDX=6754&page=1">
                                                [해적:도깨비 깃발] VIP 시사회 당첨자 안내</a>
                                        </td>
                                        <td>
                                            2022.01.12
                                            ~
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detail_view.aspx?idx=33795&LUCKEYIDX=6749&page=1">
                                                [스파이더맨 : 노 웨이 홈] 무비토이 당첨자 발표</a>
                                        </td>
                                        <td>
                                            2022.01.06
                                            ~
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detail_view.aspx?idx=33835&LUCKEYIDX=6753&page=1">
                                                &lt;해적: 도깨비 깃발&gt; CGV회원 시사회 이벤트 당첨자 안내</a>
                                        </td>
                                        <td>
                                            2022.01.10
                            ...
                            <div class="paging">
                                <ul>
                                    ...
                                    <li>
                                        <a href="/user/mycgv/event/result_list.aspx?page=2">2</a>
                                    </li>
                                    <li>
                                        <a href="/user/mycgv/event/result_list.aspx?page=3">3</a>
                                    </li>
                                    <li>
                                        <a href="/user/mycgv/event/result_list.aspx?page=4">4</a>
                                    </li>
                                    <li>
                                        <a href="/user/mycgv/event/result_list.aspx?page=5">5</a>
                                    </li>
                                    <li>
                                        <a href="/user/mycgv/event/result_list.aspx?page=6">6</a>
                                    </li>
                                    <li>
                                        <a href="/user/mycgv/event/result_list.aspx?page=7">7</a>
                                    </li>
                                    <li>
                                        <a href="/user/mycgv/event/result_list.aspx?page=8">8</a>
                                    </li>
                                    <li>
                                        <a href="/user/mycgv/event/result_list.aspx?page=9">9</a>
                                    </li>
                                    <li>
                                        <a href="/user/mycgv/event/result_list.aspx?page=10">10</a>
                                    </li>
                                </ul>
                                <button class="btn-paging next" type="button" onclick="location='/user/mycgv/event/result_list.aspx?page=11'">다음</button>
                                <button class="btn-paging end" type="button" onclick="location='/user/mycgv/event/result_list.aspx?page=291'">끝</button>
                            </div>
                            <script type="text/javascript">
