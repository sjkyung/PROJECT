...
<main>
    <div class="container-fluid px-4" style="margin:0 auto;">
        <h2 style="text-align:center;">예매  내역 상세페이지</h2>
            ...
            <div>
                <table id="datatablesSimple">
                    ...
                    <tr onclick="go_detail()">
                        <td style="width: 15%;">0204-5994-859(2022.02.24)</td>
                        <td style="width: 45%;"><img src="https://img.cgv.co.kr/WebApp/contents/eventV4/33839/16425473374760.jpg" width="150px"></td>
        ...
        <hr/>
          <button type="button" class="btn btn-primary" onclick="location.href='./member-pointlist.jsp'">목록</button>
