			...
			<div class="cols-content vip-lounge-renew">
				...
				<div class="vip-hdinfo normal">
					...
					<div class="info-area">
						...
						<p class="info-txt">
							 	<span style="font-weight: 300;"> </span> 님은   <em>일반</em>입니다.<a href="#" class="btn-moreinfo" id="chk_vipgradeinfo" style="cursor:pointer"><img src="https://img.cgv.co.kr/R2014/images/sub/vip/ico_exclamation_mark.gif" alt="?"></a>
						</p>
							...
							<!-- Contents Addon -->
								<div class="vip-stepup-cont">
									...
									<ul class="su_list">  
										...
										<li id="chkline" style=""><strong></strong>
