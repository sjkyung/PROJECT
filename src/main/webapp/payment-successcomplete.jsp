...
<head>
    ...
    <script type="text/javascript">
        ...
        //결제내역
        function fn_PaymentDetail() {
            location.href = "payment-detail.jsp?number=";
        }
    </script>
...
<li id='cm2' name='categorymenu' class=''><a href='#' onclick="javascript:fnCategoryData('2');">영화관람권</a></li><li id='cm3' name='categorymenu' class=''><a href='#' onclick="javascript:fnCategoryData('3');">기프트카드</a></li><li id='cm4' name='categorymenu' class=''><a href='#' onclick="javascript:fnCategoryData('4');">콤보</a></li><li id='cm5' name='categorymenu' class=''><a href='#' onclick="javascript:fnCategoryData('5');">팝콘</a></li><li id='cm6' name='categorymenu' class=''><a href='#' onclick="javascript:fnCategoryData('6');">음료</a></li><li id='cm7' name='categorymenu' class=''><a href='#' onclick="javascript:fnCategoryData('7');">스낵</a></li><li id='cm10' name='categorymenu' class=''><a href='#' onclick="javascript:fnCategoryData('10');">플레이존</a></li>     </ul>
    ...
    <!-- S 장바구니 단계
			Description: 
				- step 는 두가지 타입
					1. case1 : 장바구니/결제하기/결제완료
					2. case2 : 장바구니/선물정보 입력/결제하기/결제완료)
    ...
    <div class="cart_step_wrap">
        ...
        <!-- <ul class="cart_step step_unit4">
					...
					<li class="step3 active"><span>STEP 04</span><strong>결제완료</strong></li>
				</ul> -->
        <!-- S case2 -->
    </div>
    <!-- E 장바구니 단계 -->
    ...
    <div class="payment_complete_wrap">
        <div class="payment_complete_contents_wrap">
            <p>
                <strong>상품 결제가 완료되었습니다.</strong><span></span></p>
            <dl>
                <dt>총 상품금액</dt>
                <dd>
                ...
                <dt class="payment_complete_total">총 결제금액 ()</dt>
                <dd>
                    <span></span></dd>
            </dl>
        </div>
        ...
        <div class="com_btn_wrap pT60">
            <a href="#none" onclick="fn_PaymentDetail();" class="btn_style1">결제내역</a> 
            <a href="store-category.aspx?CategoryIdx=1" class="btn_style0">상품 더보기</a>
        </div>
    </div>
    <!-- E 결제완료 -->
