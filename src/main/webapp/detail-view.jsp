    ...
    $("#btnSave").on('click', function () {
        ...
        if ($("#preegg_useyn").val() == selectvalue) {
            ...
            $.ajax({
                ...
                data: "{'movieIdx':'" + movieIdx + "', 'useYN':'" + selectvalue + "', 'title':'극장판 주술회전 0'}",
...
주술사만의 낙원을 만들려는 게토는 비술사를 섬멸하겠다면서, 신주쿠와 교토에 천의 저주를 내리는데…과연 옷코츠는 게토를 막을 수 있을까? 그리고리카의 저주를 풀 수 있을까?
            ...
            <div class="sect-movielist" style="display :none">
                ...
                <ul>
                    ...
                    <li>
                        <div class="box-image">
                            <a href="/movies/detail-view/?midx=85628">
                                <span class="thumb-image">
                                    <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000085/85628/85628_126.jpg" alt="극장판 안녕 자두야: 제주도의 비밀 포스터">
                                    <span class="ico-grade grade-all">전체</span>
                                </span>
                            </a>
                        </div>
                        <div class="box-contents">
                            <a href="/movies/detail-view/?midx=85628"><strong>극장판 안녕 자두야: 제주도의 비밀</strong></a>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="box-image">
                            <a href="/movies/detail-view/?midx=85622">
                                <span class="thumb-image">
                                    <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000085/85622/85622_126.jpg" alt="빅 더 바이킹-토르와 마법의 검 포스터">
                                    <span class="ico-grade grade-all">전체</span>
                                </span>
                            </a>
                        </div>
                        <div class="box-contents">
                            <a href="/movies/detail-view/?midx=85622"><strong>빅 더 바이킹-토르와 마법의 검</strong></a>
                        </div>
                    </li>
                    
                    <li>
                        <div class="box-image">
                            <a href="/movies/detail-view/?midx=85500">
                                <span class="thumb-image">
                                    <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000085/85500/85500_126.jpg" alt="극장판 천재 추리 탐정 셜록홈즈 포스터">
                                    <span class="ico-grade grade-all">전체</span>
                                </span>
                            </a>
                        </div>
                        <div class="box-contents">
                            <a href="/movies/detail-view/?midx=85500"><strong>극장판 천재 추리 탐정 셜록홈즈</strong></a>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="box-image">
                            <a href="/movies/detail-view/?midx=84780">
                                <span class="thumb-image">
                                    <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000084/84780/84780_126.jpg" alt="씽2게더 포스터">
                                    <span class="ico-grade grade-all">전체</span>
                                </span>
                            </a>
                        </div>
                        <div class="box-contents">
                            <a href="/movies/detail-view/?midx=84780"><strong>씽2게더</strong></a>
                        </div>
                    </li>
                    
                    <li>
                        <div class="box-image">
                            <a href="/movies/detail-view/?midx=83127">
                                <span class="thumb-image">
                                    <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000083/83127/83127_126.jpg" alt="미니언즈2 포스터">
                                    <span class="ico-grade grade-none">미정</span>
                                </span>
                            </a>
                        </div>
                        <div class="box-contents">
                            <a href="/movies/detail-view/?midx=83127"><strong>미니언즈2</strong></a>
                        </div>
                    </li>
...
<div class="col-aside">
    <div class="ad-partner01">
        <iframe src="http://ad.cgv.co.kr/NetInsight/html/CGV/CGV_201401/sub@M_Rectangle" width="160" height="300" title="영화광고-인민을 위해 복무하라" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" name="M_Rectangle" id="M_Rectangle"></iframe>
    </div>
...
<!--<div class="sect-sns">
    ...
    <div class="share">
        ...
        <div class="fb-like" style="z-index:2" data-href="http%3a%2f%2fwww.cgv.co.kr%2fmovies%2fdetail-view%2fdefault.aspx%3fmidx%3d85603" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
    </div>-->
			...
			<div class="popwrap">
				...
				<div class="pop-contents write-mygrade">
					...
					<div class="mygrade-cont">
						<div class="movietit"><strong id="regTitle">극장판 주술회전 0</strong></div>
						<div class="likeornot">
    ...
    (function ($) {
        $(function () {
            ...
            var data = {
                    ...
                    age: [
                ["10대", 21.1],["20대", 47.3],["30대", 14.3],["40대", 10.4],["50대", 6.9]
                    ],
                    sex: [
                 ["남 25.3%", 25.3],["여 74.7%", 74.7]
                    ]
            ...
            function searchPointList(page, isGetTotalCount, filterType, orderType) {
	            ...
	            $.ajax({
	                ...
	                data: "{ 'movieIdx': 85603, 'pageIndex': " + page + ", 'pageSize': " + isMyPageIndex + ", 'orderType': " + orderType + ", 'filterType': 1, 'isTotalCount' : " + isGetTotalCount + ", 'isMyPoint' : '" + isMyPoint + "' }",
	                contentType: "application/json; charset=utf-8",
	                dataType: 'json',
	                success: function (result) {
			...
			$('.link-gradewrite').on('click', function () {
                ...
                movObj.GetWatchingMovieCheck(JSON.stringify({ 'MovieIdx': 85603 }), GetWatchingMovieCheckCallback);
            ...
            function RegPop(){
                ...
                $('#regBtn').on('click', function () {
                    ...
                    app.movie().getViewUser({ 'movieIdx': '85603', 'isOpenView': isChecked }, callback); /*[2015-12-09]실관람객여부 체크 시 진짜 인지를 확인 & 이미 평점을 작성한 적이 있는지 확인. : upt_mwpark*/
