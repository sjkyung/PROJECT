                        ...
                        <div class="email_list_area">
                            ...
                            <form id="form1" method="post" novalidate="novalidate" action="">
                                <fieldset>
                                    ...
                                    <div class="tbl_area">
                                        ...
                                        <table cellspacing="0" cellpadding="0" class="tbl_notice_list tbl_left">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="startdate" name="startdate" value="2022-02-16" datepicker="datepicker" class="inp01" style="width:75px;" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="inp_name" name="inp_name" class="inp01" style="width: 188px;" value="이순자" onkeypress="return char_check(event)" />
                                                    <input type="hidden" id="inp_id" name="inp_id" value="leesj3815" />
                                                </td>
                                                <th><label for="inp_hp">연락처<em><img src="http://img.cgv.co.kr/R2014/images/common/ico/ico_redstar.png" alt="필수" /></em></label></th>
                                                <td><input type="text" id="inp_hp" name="inp_hp" class="inp01" style="width: 208px;" value="01081813815"  placeholder="'-'없이 입력해주세요" onkeydown="allowOnlyNumeric();" maxlength="11" /></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="3" class="inp_email">
                                                    <div class="mailBox">
                                                        <div class="input_wrap">
                                                            <input type="text" id="inp_email" name="inp_email" value="kang100ho10@naver.com" class="inp01" style="width:250px"/>
                                    ...
                                    <div class="box-btn">
                                        <a style="margin-left:5px" href="./support.jsp" class="round gray"><span style="padding:0 14px;">취소</span></a>
