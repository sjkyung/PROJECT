...
<html>
<head>
    <title>mycgv-myinfo-edit-myinfo-myprofile</title>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="sect-profile-img">
                                        <div class="box-image">
                            <span class="thumb-image">
                                <img id="img_userprofileimage" src="" alt="김태훈님 프로필 사진" onerror="errorImage(this, {type:'profile'})" />
                                <span class="profile-mask"></span>
