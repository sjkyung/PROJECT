...
`				<div class="curation clear" id="stillcut_list" style="min-height: 700px;">
					...
					<a id="tile_0" href="#">
					<img src="css/1.jpg" alt="나일 강의 죽음" style="height: 300px;">
					</a
					></div>
					
					<div class="imgclick" style="position: absolute; top: 0px; left: 270px;">
					<a id="tile_1" href="#">
					<img src="css/2.jpg" alt="나일 강의 죽음" style="height: 300px;">
					</a>
					</div>
					
					<div class="imgclick" style="position: absolute; top: 0px; left: 540px;">
					<a id="tile_2" href="#">
					<img src="css/3.jpg" alt="나일 강의 죽음" style="height: 300px;">
					</a>
					</div>
					...
					<a id="tile_3" href="#">
					<img src="css/4.jpg" alt="나일 강의 죽음" style="height: 300px;">
					</a>
					</div>
					
					<div class="imgclick" style="position: absolute; top: 381px; left: 270px;">
					<a id="tile_4" href="#">
					<img src="css/5.jpg" alt="나일 강의 죽음" style="height: 300px;">
					</a>
					</div>
                <div class="col-aside">
