		...
		<div class="benefitbox-spot type2">
			<div class="kids-movie">
				...
				<div class="slider" id="kidsMovieSlider">
							...
							<div class="item">
								<a href="/movies/detail-view/?midx=85641">
									<span class="km-poster">
										...
										&nbsp;<span class="movie-infocon"><strong class="km-movietit">해리 포터와 불사조 기사단</strong><span class="score"><strong class="percent">예매율<span>7.04%</span></strong>
							...
							<div class="item">
								<a href="/movies/detail-view/?midx=83152">
									<span class="km-poster">
										...
										&nbsp;<span class="movie-infocon"><strong class="km-movietit">나의 촛불</strong><span class="score"><strong class="percent">예매율<span>1.31%</span></strong>
												<span class="egg-gage small">
													<span class="egg great"></span>
													<span class="percent">98%</span>
												</span>
							...
							<div class="item">
								<a href="/movies/detail-view/?midx=84945">
									<span class="km-poster">
										...
										&nbsp;<span class="movie-infocon"><strong class="km-movietit">듄</strong><span class="score"><strong class="percent">예매율<span>12.03%</span></strong>
												<span class="egg-gage small">
													<span class="egg great"></span>
							...
							<div class="item">
								<a href="/movies/detail-view/?midx=83739">
									<span class="km-poster">
										...
										&nbsp;<span class="movie-infocon"><strong class="km-movietit">나일 강의 죽음</strong><span class="score"><strong class="percent">예매율<span>9.33%</span></strong>
												<span class="egg-gage small">
													<span class="egg great"></span>
                        ...
                        <div class="item-wrap">
							<div class="item">
								<a href="/movies/detail-view/?midx=85646">
									<span class="km-poster">
										<span class="thumb-image">
										...
										&nbsp;<span class="movie-infocon"><strong class="km-movietit">[아트&amp;다이닝]나폴리, 예술과 정열을 말하다</strong><span class="score"><strong class="percent">예매율<span>0.05%</span></strong>
												<span class="egg-gage small">
							...
							<div class="item">
								<a href="/movies/detail-view/?midx=85624">
									<span class="km-poster">
										...
										&nbsp;<span class="movie-infocon"><strong class="km-movietit">언차티드</strong><span class="score"><strong class="percent">예매율<span>18.3%</span></strong>
												<span class="egg-gage small">
													<span class="egg good"></span>
													<span class="percent">?</span>
												</span>
...
// 키즈패밀리 Club 초기화
    ...
    $("#btn_popkizWithdraw").click(function () {
        ...
        if ($('#kizPasswordInfo').prop('checked') == false) {
            ...
            $.ajax({
                ...
                data: "{UserID : '',  userPwKiz : '" + passwordInput + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    var json = $.parseJSON(data.d);
                ...
                error: function (request, error) {
                    alert("code11:" + request.statusText + request.readyState + "\n" + "error:" + error);
                }
            });
    ...
    $("#downCoupon1").click(function () {
        if ("False" == "False") {
            ...
            $.ajax({
                ...
                error: function (request, error) {
                    alert("code12:" + request.statusText + request.readyState + "\n" + "error:" + error);
                }
            });
    ...
    <script type="text/javascript">
        ...
        $('#nobleBlackCardStatus').click(function () {
            if ("False" == "False") { goLogin(); event.preventDefault(); }
		...
		function withDrawNobleClub() {
		    if ("False" == "False") goLogin();
		        ...
		        $.ajax({
		            ...
		            data: "{ 'userID':'', 'password':'" + app.crypto.AESEncryptToBase64(passwordInput) + "'}",
		            contentType: "application/json; charset=utf-8",
		            dataType: "json",
		            success: function (data) {
		                var json = $.parseJSON(data.d);
        ...
        <div class="benefitbox">
			...
			<div class="benefitbox-spot movie-board" id="redCardMovieList">
				<div class="mb-box">
					...
					<ul class="mb-list" id="redCardNow"><li><a href="/movies/detail-view/?midx=85641"><span class="thumb-image"><img src="http://img.cgv.co.kr/Movie/Thumbnail/Poster/000085/85641/85641_320.jpg" alt="해리 포터와 불사조 기사단" onerror="errorImage(this)" style="width: 100%; height: 100%;"><span class="movie-infocon"><strong class="km-movietit">해리 포터와 불사조 기사단</strong><span class="km-date">2022.02.09 개봉</span></span></span></a></li></ul>
				</div>
				<div class="mb-box">
					<strong class="mb-tit">COMING SOON</strong>
					<ul class="mb-list" id="redCardComming"><li><a href="/movies/detail-view/?midx=85603"><span class="thumb-image"><img src="http://img.cgv.co.kr/Movie/Thumbnail/Poster/000085/85603/85603_320.jpg" alt="극장판 주술회전 0" onerror="errorImage(this)" style="width: 100%; height: 100%;"><span class="movie-infocon"><strong class="km-movietit">극장판 주술회전 0</strong><span class="km-date">2022.02.17 개봉</span></span></span></a></li><li><a href="/movies/detail-view/?midx=85624"><span class="thumb-image"><img src="http://img.cgv.co.kr/Movie/Thumbnail/Poster/000085/85624/85624_320.jpg" alt="언차티드" onerror="errorImage(this)" style="width: 100%; height: 100%;"><span class="movie-infocon"><strong class="km-movietit">언차티드</strong><span class="km-date">2022.02.16 개봉</span></span></span></a></li></ul>
				</div>
			</div>
    ...
    <script type="text/javascript">
        ...
        function getBenefitList() {
            ...
            $.ajax({
                ...
                data: "{ 'userid':'', 'CardNo':'', 'CardSDate':'', 'CardEDate':''}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    var json = $.parseJSON(data.d);
